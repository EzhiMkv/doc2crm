...
| 📄 → 💼 Фото счёта → сделка | 🔎 Вопрос по документам с цитатами |
|---|---|
| ![Фото счёта → сделка в CRM](docs/screenshots/demo_photo_to_deal.png) | ![Вопрос с цитатами](docs/screenshots/demo_qa_citations.png) |

| 🧮 Агрегация по документам | 🔍 Ответы строго из цитат |
|---|---|
| ![Агрегация](docs/screenshots/demo_qa_aggregate.png) | *модель отвечает только по найденным цитатам, без выдумок* |
